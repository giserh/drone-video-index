...
{
 assert(p);
 assert(!p->taken[i]);//ǰ�ᶼ��δ����

 p->partition[i] = group;//��i����֧���ڵ�group��
 p->taken[i] = TRUE;//��i����֧�ѷֹ���

 ////////////////////////////////////////////////////////////����������mbrֵ�ܺ�
 if (p->count[group] == 0)//����group����֧��Ϊ��ʱ
 {
	 for(int j=0; j<MBR_NUMB; j++)
	 {
...
void _TetraRTreePickSeeds(HTETRARTREEROOT root, TETRARTREEPARTITION *p)
{
 ...
 for (i=0; i<p->total-1; i++)//ɨ��������֧���������ϣ�����waste{area(A+B)-area(A)-area(B)}ֵ������һ��
 {
